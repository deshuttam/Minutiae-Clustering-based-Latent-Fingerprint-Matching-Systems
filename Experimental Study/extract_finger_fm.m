       ...
       if minutiae(i, 4) > pi
        for k = y1-2: y1 + 2
          for l = x1-2: x1 + 2
            ...
            minutiae_i(k, l,:)= [0]; 
            % minutiae_i(k, l,:)= [0]; %25 percent MM
           % minutiae_i(k, l,:)= [0]; %50 percent MM
            %minutiae_i(k+x1-y1, l,:)= [0]; %25 percent SM
            
            minutiae_i(k+25, l+25,:)= [0]; %50 percent SM
        ...
        for k = y1-2: y1 + 2
          for l = x1-2: x1 + 2
            ...
            minutiae_i(k, l,:)= [0];
           % minutiae_i(k+6, l,:)= [0]; %25 percent SM
          minutiae_i(k+50, l+50,:)= [0]; %50 percent SM
          end
        end
       end
    elseif minutiae(i, 3) == 2
        for k = y1-2: y1 + 2
          for l = x1-2: x1 + 2
            ...
            minutiae_i(k, l,:)= [0];
           % minutiae_i(k, l,:)= [0]; %50 percent MM
          %   minutiae_i(k+9, l,:)= [0]; %25 percent SM
           minutiae_i(k+25, l+25,:)= [0]; %50 percent SM
          end
        end
      ...
      if minutiae(i, 4) > pi
        for k = y1-2: y1 + 2
          for l = x1-2: x1 + 2
            ...
            minutiae_i(k, l,:)= [0];
          %   minutiae_i(k+12, l,:)= [0]; %25 percent SM
           minutiae_i(k+50, l+50,:)= [0]; %50 percent SM
          end
        end
      else 
        for k = y1-2: y1 + 2
          for l = x1-2: x1 + 2
            ...
            minutiae_i(k, l,:)= [0];
           % minutiae_i(k, l,:)= [0]; %50 percent MM
          %  minutiae_i(k+15, l,:)= [0]; %25 percent SM
         minutiae_i(k+25, l+25,:)= [0]; %50 percent SM
          end
        end
      end
    elseif minutiae(i, 3) == 5
        for k = y1-4: y1 + 4
          for l = x1-4: x1 + 4
            ...
            minutiae_i(k, l,:)= [0];
           %  minutiae_i(k+18, l,:)= [0]; %25 percent SM
          minutiae_i(k+50, l+50,:)= [0]; %50 percent SM
          end
        end
    ...
    elseif minutiae(i, 3) > 5
        for k = y1-2: y1 + 2
          for l = x1-2: x1 + 2
              ...
              minutiae_i(k, l,:)= [0];
           %     minutiae_i(k+21, l,:)= [0]; %25 percent SM
           minutiae_i(k+25, l+25,:)= [0]; %50 percent SM
          end
        end
    end   
