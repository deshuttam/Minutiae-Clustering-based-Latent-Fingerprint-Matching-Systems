...
files = dir('F:\PhD\Software\Matlab\sc_minutia\sc_minutia\DB1_B\NIST\*.tif');
cd  'F:\PhD\Software\Matlab\sc_minutia\sc_minutia\DB1_B\NIST\';
...
for index1 = o_start+1: 1%(numel(file_names))
